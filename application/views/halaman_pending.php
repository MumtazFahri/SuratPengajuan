...
<!-- PERBAIKAN: Modal Reject dengan desain yang lebih baik seperti di halaman_total.php -->
<template id="rejectModalTemplate">
    <div class="modal-content" style="max-width: 600px; width: 95%; max-height: 85vh;">
        <div class="modal-header" style="background: #e74c3c;">
            <h3 style="display: flex; align-items: center; gap: 10px;">
                <i class="fa-solid fa-triangle-exclamation"></i> Tolak Pengajuan
            </h3>
            <button class="close-modal">&times;</button>
        </div>
        <div style="padding: 30px;">
            <!-- Informasi Pengajuan -->
            <div style="background: #fff5f5; border: 1px solid #f8d7da; border-radius: 10px; padding: 20px; margin-bottom: 25px;">
                <div style="display: flex; align-items: flex-start; gap: 15px;">
                    <div style="background: #e74c3c; color: white; width: 40px; height: 40px; border-radius: 50%; display: flex; align-items: center; justify-content: center; font-size: 18px; flex-shrink: 0;">
                        <i class="fa-solid fa-exclamation"></i>
                    </div>
                    <div>
                        <h4 style="margin: 0 0 8px 0; color: #721c24; font-size: 16px;">Konfirmasi Penolakan</h4>
                        <p style="margin: 0; color: #856404; font-size: 14px;">
                            Anda akan menolak pengajuan ini. Berikan alasan penolakan yang jelas.
                        </p>
                    </div>
                </div>
                <div style="margin-top: 15px; padding-top: 15px; border-top: 1px solid #f8d7da;">
                    <div style="display: flex; align-items: center; gap: 10px; margin-bottom: 5px;">
                        <i class="fa-solid fa-clipboard-list" style="color: #e74c3c; font-size: 14px;"></i>
                        <span style="font-weight: 600; color: #495057; font-size: 15px;">Nama Kegiatan:</span>
                    </div>
                    <div style="background: white; padding: 12px 15px; border-radius: 6px; border: 1px solid #f8d7da; margin-top: 8px;">
                        <span class="reject-nama-kegiatan" style="color: #212529; font-weight: 500;">-</span>
                    </div>
                </div>
            </div>
            ...
            <div style="margin-bottom: 30px;">
                <div style="display: flex; align-items: center; gap: 10px; margin-bottom: 12px;">
                    <i class="fa-solid fa-comment-medical" style="color: #e74c3c; font-size: 16px;"></i>
                    <label style="font-weight: 600; color: #495057; font-size: 15px;">
                        Alasan Penolakan <span style="color: #e74c3c;">*</span>
                    </label>
                </div>
                <div style="position: relative;">
                    <textarea 
                        class="rejection-notes" 
                        rows="6" 
                        placeholder="Tuliskan alasan penolakan secara jelas dan detail..." 
                        style="width: 100%; padding: 15px; border: 2px solid #e0e0e0; border-radius: 10px; font-family: inherit; font-size: 14px; line-height: 1.5; resize: vertical; transition: all 0.3s; background: #fff;"
                    ></textarea>
                </div>
            </div>

            <!-- Tombol Aksi -->
            <div style="display: flex; justify-content: flex-end; gap: 15px; padding-top: 25px; border-top: 1px solid #e9ecef;">
                ...
                <button type="button" class="btn-submit-reject" style="
                    background: #e74c3c; 
                    color: white; 
                    border: none; 
                    padding: 12px 25px; 
...
class ModalManager {
    ...
    // PERBAIKAN: Create reject modal dengan desain yang sama seperti di halaman_total.php
    ...
    // PERBAIKAN: Attach reject modal listeners dengan desain yang sama
    attachRejectModalListeners(modalElement, modalId, data) {
        const submitBtn = modalElement.querySelector('.btn-submit-reject');
        const textarea = modalElement.querySelector('.rejection-notes');
    ...
    // Submit reject form yang disederhanakan (tanpa minimal karakter)
    submitRejectForm(modalElement, suratId) {
        ...
        if (!notes) { 
            ...
            // Efek shake pada textarea
            const textarea = modalElement.querySelector('.rejection-notes');
            textarea.style.borderColor = '#e74c3c';
            textarea.style.boxShadow = '0 0 0 2px rgba(231, 76, 60, 0.3)';
            textarea.focus();
