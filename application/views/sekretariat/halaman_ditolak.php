...
<style>
    ...
    *{margin:0;padding:0;box-sizing:border-box}
    ...
    /* ============================================
       ...
       DITAMBAHKAN DARI halaman_total.php
    ============================================ */
            ...
            <div class="surat-preview-container">
                <div class="surat-preview-header">
                    ...
                    <div class="surat-toolbar">
                        <button class="surat-btn surat-btn-download" title="Download PDF">
                            <i class="fa-solid fa-download"></i> Download
                        </button>
                        <button class="surat-btn surat-btn-print" title="Print Surat">
                            <i class="fa-solid fa-print"></i> Print
                        </button>
                        <button class="surat-btn surat-btn-fullscreen" title="Fullscreen">
...
class ModalManager {
    ...
    // Attach surat modal listeners - DITAMBAHKAN FITUR FULLSCREEN
    ...
    // Load surat content - DITAMBAHKAN FITUR FULLSCREEN
...
// ============================================
// FUNGSI FULLSCREEN YANG DIPERBAIKI - SAMA SEPERTI halaman_total.php
// ============================================
