...
<style>
    /* ============================================
       STYLE DASAR (SAMA SEPERTI TOTAL)
    ============================================ */
    *{margin:0;padding:0;box-sizing:border-box}
    ...
    /* ============================================
       TOMBOL DASHBOARD (SAMA SEPERTI TOTAL)
    ============================================ */
    ...
    /* ============================================
       DISPOSISI STYLES (SAMA SEPERTI TOTAL)
    ============================================ */
    .btn-disposisi {
        background:#f1c40f;
        color:#000;
    ...
    /* ============================================
       SEARCH & FILTER (SAMA SEPERTI TOTAL)
    ============================================ */
    ...
    /* ============================================
       FULLSCREEN STYLES - PERBAIKAN: UKURAN LEBIH SEMPIT DAN RAPIH
    ============================================ */
...
<div class="container">
    ...
    <div class="card">
        <div class="card-header">
            <h3><i class="fa-solid fa-table"></i> Daftar Pengajuan Disetujui - Sekretariat</h3>
            <div>
                <span id="filterInfo" style="color:#7f8c8d;font-size:13px">
                    Menampilkan: Semua Data (<?= isset($surat_list) ? count($surat_list) : '0' ?> data)
                </span>
            </div>
        </div>
        ...
        <div class="search-filter-container">
            ...
            <a href="<?= base_url('sekretariat/disetujui') ?>" class="btn-secondary">
            ...
            <table>
                ...
                <tbody id="tableBody">
                    <?php if(isset($surat_list) && !empty($surat_list)): $no=1; foreach($surat_list as $s): 
                        ...
                        // REVISI: Kolom Tanggal Kegiatan - Tampilkan Periode atau Tanggal (SAMA SEPERTI TOTAL)
                        ...
                        // Determine tanggal kegiatan display (SAMA SEPERTI TOTAL)
                        ...
                        if ($status == 'disetujui sekretariat') {
                            ...
                            <div class="action-buttons">
                                ...
                                <?php if($status == 'disetujui dekan'): ?>
                                    <button class="btn btn-nomor" 
                                            onclick="event.stopPropagation(); openNomorSuratModal(<?= $id ?>, '<?= htmlspecialchars(addslashes($nama_kegiatan)) ?>')"
                                ...
                                <?php if($status == 'disetujui dekan' && !empty($nomor_surat) && $nomor_surat !== '-' && $nomor_surat !== 'null'): ?>
                                    <button class="btn btn-cetak" 
                                            onclick="event.stopPropagation(); window.open('<?= site_url('surat/cetak/' . $id) ?>', '_blank')"
                                            title="Cetak Surat">
                    ...
                    <tr>
                        <td colspan="9" style="text-align:center;padding:40px;color:#7f8c8d">
                            ...
                            <strong>Tidak ada pengajuan yang disetujui</strong>
                        </td>
                    </tr>
                    <?php endif; ?>
                </tbody>
...
<!-- Modal Templates (SAMA DENGAN TOTAL) -->
...
function updatePaginationInfo(visibleCount) {
    ...
    if (paginationInfo && filterInfo) {
        if (currentSearchTerm) {
            ...
            paginationInfo.textContent = `Menampilkan: Semua Pengajuan Disetujui (${total} data)`;
